(function() {
    Ext.define('CMDBuildUI.locales.en.Locales', {
        ...
        "bulkactions": {
            ...
            "alertnoattachmentsdownload": "No attachments will not be downloaded because they have not yet been saved to the server",
        ...
        "widgets": {
            "attachment": {
                "actions": {
                    ...
                    "stayinedit": "Stay in edit"
                },
                "savebeforeexit": "Do you want save attachments before exit?",
                "saveprocessmessage": "Attachments can only be saved on existing cards. If you press save, the process instance will be created with the data you entered."
            },
            "customform": {
                "addrow": "Add row",
                "clonerow": "Clone row",
