...
CREATE OR REPLACE FUNCTION _cm3_dashboard_functions_load() RETURNS VOID AS $$ BEGIN --TODO schedule this at startup!
    PERFORM _cm3_renew_cached_records('_cm3_dashboard_records_history_actual'::regproc);
    PERFORM _cm3_renew_cached_records('_cm3_dashboard_disk_usage_actual'::regproc);
END $$ LANGUAGE PLPGSQL;
